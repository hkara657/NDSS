...
unsigned char tp_key[256]={"89f6806368c130627a98bfb6bb5b1fd7"};
unsigned char tp_iv[256]={"b24d13affed86717df32a5b43fa9b859"};
unsigned char inp[256]={"056f3063170450a5ac72c15caa54c690"};
unsigned char exp_out[256] = {"6754f2521b14154819b1b4f2a98a89fa"};
...
//////////////////// uncomment to print intermediate values  /////////////////////////			
	...
	//~ //				printf("%d %d\n",pt_len,ciphertext_len);
		...
		for(l=0;l<key_len;l++)
			key[i+1][l]=key[i][l]^ciphertext[j][l];

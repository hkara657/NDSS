...
int main(int argc, char *argv[])
{
	...
	n=read(sockfd,&cert_of_c,sizeof(struct certificate));
	...
	n=read(sockfd1,&cert_of_b,sizeof(struct certificate));
	printf("B's certificate received\n");
	
	sleep(2);	
	write(sockfd1,&cert_of_c,sizeof(struct certificate));
	...
	if(v!=r || time(NULL)>cert_of_b.expire_time)
	{
